...
pub const devices = struct {
    pub const ATtiny412 = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const TCA0 = @intToPtr(*volatile types.peripherals.TCA.TCA, 0xa00);
            ///  16-bit Timer Type B
...
pub const types = struct {
    pub const peripherals = struct {
        ...
        pub const TCA = struct {
            ...
            pub const TCA_SINGLE = extern struct {
                ///  Control A
                CTRLA: mmio.Mmio(packed struct(u8) {
                    ///  Module Enable
                    ENABLE: u1,
            ...
            pub const TCA_SPLIT = extern struct {
                ///  Control A
                CTRLA: mmio.Mmio(packed struct(u8) {
                    ///  Module Enable
                    ENABLE: u1,
        ...
        pub const USART = extern struct {
            ...
            pub const USART_MSPI_CMODE = enum(u2) {
                ///  Asynchronous Mode
                ASYNCHRONOUS = 0x0,
                ///  Synchronous Mode
                SYNCHRONOUS = 0x1,
            ...
            ///  Communication Mode select
            pub const USART_NORMAL_CMODE = enum(u2) {
                ///  Asynchronous Mode
                ASYNCHRONOUS = 0x0,
                ///  Synchronous Mode
                SYNCHRONOUS = 0x1,
